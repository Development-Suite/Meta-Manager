...
function parseQueryOptions(query) {
    ...
    if (query.page !== undefined)
        opts.page = parseInt(String(query.page), 10) || 1;
    if (query.limit !== undefined)
        opts.limit = parseInt(String(query.limit), 10) || 20;
    if (query.sort !== undefined)
        opts.sort = String(query.sort);
    ...
    if (query.search !== undefined)
        opts.search = String(query.search);
...
function buildSortObject(sort, order, defaultSort, defaultOrder) {
