 ...
 */
export type UpdateEventCallback<T = Record<string, unknown>> = (
  whatWas: Partial<T>,
  whatIs: Partial<T>,
  entity: T
) => void | Promise<void>;
 ...
 */
export type CreateEventCallback<T = Record<string, unknown>> = (
  whatWas: null,
  whatIs: null,
  entity: T
) => void | Promise<void>;
 ...
 */
export type DeleteEventCallback<T = Record<string, unknown>> = (
  whatWas: Partial<T>,
  whatIs: null,
  entity: T
) => void | Promise<void>;
 ...
 */
export type RestoreEventCallback<T = Record<string, unknown>> = (
  whatWas: null,
  whatIs: null,
  entity: T
) => void | Promise<void>;
 ...
 */
export type CallbackForEvent<T, E extends string> =
  E extends "create"
    ? CreateEventCallback<T>
    : E extends "delete"
    ? DeleteEventCallback<T>
    : E extends "restore"
    ? RestoreEventCallback<T>
    : E extends "update" | `update.${string}`
